...
\begin{figure}[ht]
	...
	\begin{subfigure}{.49\textwidth}
	  \centering
	  \includegraphics[width=.9\linewidth]{figures/C3/WaldpeterField/Waldpeter-CoverageGE.jpg}
	  \caption{Field 1}
	  \label{sfig:F1-CPP-path}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=.9\linewidth]{figures/C3/Field2/Field2-CoverageGE.jpg}
	  \caption{Field 2}
	  \label{sfig:F2-CPP-path}
	\end{subfigure}
	\begin{subfigure}{.49\textwidth}
	  \centering
	  \includegraphics[width=.9\linewidth]{figures/C3/Field3/Field3-CoverageGE.jpg}
	  \caption{Field 3}
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Coverage Path generated with: (\subref{sfig:F3-regular-start-pos}) \textit{Computed} and (\subref{sfig:F3-modified-start-pos}) \textit{Custom} starting position}
    \label{fig:SITL-architecture}
\end{figure}
