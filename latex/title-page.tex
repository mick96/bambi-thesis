...
\vskip 5mm
\rule{12cm}{0.4mm}
\rule[0.5cm]{12cm}{0.1mm}\\
\vskip -5pt
{\LARGE\textbf{{Agricultural Field Detection}}}\\
\vspace{.5em}
{\LARGE{\textbf{{and Coverage Path Planning}}}}\\
\vspace{.5em}
...
\vskip -2pt
\rule{12cm}{0.1mm}
\rule[0.5cm]{12cm}{0.4mm}\\
\vspace{5mm} {\Large{\textsc{Tesi di Laurea}}}\\
in\\
{\large{\textsc{Controlli Automatici}}}
